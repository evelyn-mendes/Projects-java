...
This application stores two numbers, and with them, you can perform some mathematical operations such as addition, subtraction, multiplication, or division, and print the result, and whether it is even or odd, and if it is a decimal or an integer. It was made using the language `Java` and the `VSCODE` IDE.
