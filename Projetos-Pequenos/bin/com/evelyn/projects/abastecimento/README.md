...
## 📖 Sobre
Esta aplicação armazena o tipo do combustível e quantos litros o usuário deseja abastecer. Caso a quantidade de litros for maior que 20, aplicasse um desconto de 5%, caso contrário, aplicasse 3%. Em seguida, o programa calcula quanto ele deverá pagar e imprime o resultado. Foi feita utilizando apenas a `linguagem java` e a IDE `vscode`.
...
## 📖 About    
This application stores the type of fuel and how many liters the user wants to fill. If liters are greater than 20, it applies a 5% discount, if not, a 3% discount, then it calculates how much he will have to pay and prints the result. It was made using the `language java` and the `vscode` IDE.
...
This project is licensed under the MIT License - see the LICENSE file for details. AUTHORS OR COPYRIGHT HOLDERS BE LIABLE FOR ANY CLAIM, DAMAGES OR OTHER LIABILITY, WHETHER IN AN ACTION OF CONTRACT, TORT OR OTHERWISE, ARISING FROM, OUT OF OR IN CONNECTION WITH THE SOFTWARE OR THE USE OR OTHER DEALINGS IN THE SOFTWARE.
