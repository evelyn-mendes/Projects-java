...
## 📖 Sobre
Está aplicação receberá N idades de alunos, e imprime a média de idade da sala, e diz se a sala é jovem, adulta ou idosa, baseada na média das idades. Foi feita utilizando apenas a linguagem `Java` e a IDS `VSCODE`.
...
## 📖 About
This application will receive N ages of students, and prints the average age of class, and says whether the class is young, adult or elderly, based on the average age. It was made using the language `Java` and the `VSCODE` IDE.
