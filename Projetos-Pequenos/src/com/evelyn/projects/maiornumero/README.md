...
## 📖 Sobre
Esta aplicação receberá 5 números e imprime na tela o maior número dentre os digitados. Foi feita utilizando apenas a linguagem `Java` e a IDS `VSCODE`.
...
## 📖 About
This application will receive 5 numbers and display on the largest one among those entered. It was made using the language `Java` and the `VSCODE` IDE.
