...
## 📖 Sobre
Este aplicativo armazena altura e peso do usuário e o seu IMC. Foi feito apenas utilizando a linguagem `Java` e a IDE `VSCODE`.
...
This application stores the weight and height of the user and calculate your BMI. It was made using the language `Java` and the `VSCODE` IDE.
